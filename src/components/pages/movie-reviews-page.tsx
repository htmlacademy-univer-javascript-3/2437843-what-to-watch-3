            ...
            <div className="film-card__desc">
              ...
              <div className="film-card__reviews film-card__row">
                <div className="film-card__reviews-col">
                  ...
                  <div className="review">
                    <blockquote className="review__quote">
                      <p className="review__text">Anderson&lsquo;s films are too precious for some, but for those of us
                        willing to lose ourselves in them, they&lsquo;re a delight. &quot;The Grand Budapest Hotel&quot; is no
                  ...
                  <div className="review">
                    <blockquote className="review__quote">
                      <p className="review__text">I didn&lsquo;t find it amusing, and while I can appreciate the creativity,
                        it&lsquo;s an hour and 40 minutes I wish I could take back.
                      </p>
